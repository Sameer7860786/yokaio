  ...
  gallery: [
    {
      ...
      category: "Rebel",
      rarity: "Legendary",
      image: "/assets/yokai_kitsune_1782119373638.jpg",
      description: "A phantom tech operative wearing an advanced digital LED mask and sharp formal suit. Blends cybernetic tech with high-class style.",
      characterLore: "Known across the net as a ghost in the machine. Cipher operates in the shadows of the megacorps, leaving only glowing cross-eyes as his calling card.",
      displayOrder: 1,
      visible: true,
      featured: true
    },
    {
      ...
      category: "Instigator",
      rarity: "Rare",
      image: "/assets/yokai_samurai_1782119390263.jpg",
      description: "A lilac-haired instigator with glasses and a devious smirk. Defies authority with peak confidence and sheer intellect.",
      characterLore: "Kova is a brilliant system-breaker who uses a sharp collared shirt to hide his chaotic underground activities. He rules the cyber-alleys.",
      displayOrder: 2,
      visible: true,
      featured: false
    },
    {
      ...
      category: "Hunter",
      rarity: "Epic",
      image: "/assets/yokai_guardian_1782119409093.jpg",
      description: "A tactical huntsman featuring neat dreadlocks, high-tech tactical vest, and carrying a massive carbon scythe on his shoulder.",
      characterLore: "Born in the cyber-wastes, Scythe hunts down rogue protocols and rogue entities with military precision and silent hunting steps.",
      displayOrder: 3,
      visible: true,
      featured: false
    },
    {
      ...
      category: "Legend",
      rarity: "Mythic",
      image: "/assets/yokai_dragon_1782119427697.jpg",
      description: "A mystical martial artist with lavender-purple skin tones, black-and-white hair in a bun, and tattered training robes holding a focused mudra sign.",
      characterLore: "A legendary Zen master who achieved full spiritual sync. Zenith channels cosmic energies to protect the sacred core of the YOKAIO universe.",
      displayOrder: 4,
      visible: true,
      featured: true
    }
